...
function dologin() {
    var uname = e("username").value;
    var pwd = e("password").value;
    $.post("/lanqiao.LanqiaoLogin.dt", {username: uname, password: pwd, type: 's'}, function (obj) {
        if ("" + obj["ret"] != "1") alert("登录失败"); else location.reload();
    }, "JSON");
}
...
function dologinc() {
    var uname = e("username").value;
    var pwd = e("password").value;
    $.post("/lanqiao.LanqiaoLogin.dt", {username: uname, password: pwd, type: 'c'}, function (obj) {
        if ("" + obj["ret"] != "1") alert("登录失败"); else location.reload();
    }, "JSON");
}
